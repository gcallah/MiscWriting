...
The label shifts — the machine is the same!
...
AI and Semiotics 2026
In the late 1930s, Alan Turing described a remarkably simple theoretical machine—a tape, a read-write head, and a set of rules—that could read, write, and move along the tape. Despite its simplicity, this model showed how any mechanical computation could be performed.
...
We use electronics not because they’re theoretically superior, but because they’re far faster, even though a water or pneumatic computer could compute the same things.
AI and Semiotics 2026
...
Modern LLMs may seem fundamentally different from a water computer, but similar claims were made for earlier technologies, and all overlook the Church–Turing Thesis!

In principle, any system capable of computation can perform the same calculations, and LLM training itself begins by stripping inputs of meaning into abstract representations.
...
Hilary Putnam showed essentially the complementary result: multiple physical states can have the same meaning: the brains of a human, an octopus, and a Martian can all “represent” the experience of pain.
